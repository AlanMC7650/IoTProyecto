...
import { SerieFibonacci } from "../entities/SerieFibonacci";

const repo = AppDataSource.getRepository(SerieFibonacci);

export const FibonacciRepository = {
  guardarLote(filas: DeepPartial<SerieFibonacci>[]) {
